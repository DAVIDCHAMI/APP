...
Característica: Autenticación app Bancolombia
  ...
  Esquema del escenario: Acceso exitoso a la aplicacion de Bancolombia OSP
    ...
    Ejemplos:
      | ID | numeroDocumento | tipoDocumento | usuario    | clave | segundaClave | orientacion | codigoError | codigoTransaccion | resultadoEsperado | primeraPregunta | validarClave |
   ##@externaldata@./src/test/resources/datadriven/autenticacion/Autenticacion.xlsx@Prueba@1
   |1   |43024987   |1   |automata87   |1234   |4321   |Acierto   |000   |0369   |NO ERROR   |bolp   |ACTIVO|
