...
Característica: Registro en la APP personas bancolombia OSP
  ...
  Esquema del escenario: Verificar el registro ingresando con documento de identidad
   ...
   ##@externaldata@./src/test/resources/datadriven/registro/registro.xlsx@Datos
      | 1  | 1010111         | 1             | 1010111 | 2443  | 4321         | Acierto     | 000         | 0369              | NO ERROR          | bolp            | ACTIVO       | pruebasqa99 | jalzate@todo1.net |
