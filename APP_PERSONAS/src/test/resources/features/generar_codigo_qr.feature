...
Característica: Generación de código QR
  ...
  Esquema del escenario: Generación de codigo QR sin valor
    ...
    Cuando quiere ingresar desde GENERAR_CODIGO_QR con el documento <usuario> con clave <clave>
  ...
  @manual
  Esquema del escenario: Generación de codigo QR con única cuenta deposto
    Dado que el Actor carga los datos para la prueba
      | <ID> | <orientacion> | <codigoError> | <codigoTransaccion> | <resultadoEsperado> | <tipoDocumento> | <numeroDocumento> | <segundaClave> | <primeraPregunta> | <validarClave> |
    Cuando quiere ingresar desde GENERAR_CODIGO_QR con el documento <usuario> con clave <clave>
    Y quiere generar un codigo QR sin valor
