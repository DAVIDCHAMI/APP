...
public class ConsultarDetalleFacturaStepDefinition {
  ...
  public void revisaConsultaDeSusFacturasInscritas() {
    theActorInTheSpotlight().attemptsTo(AdministrarFactura.conOpcionConsultarFacturasInscritas());
  }

  @Cuando("el actor realiza la consulta de sus facturas programadas$")
  public void revisaConsultaDeSusFacturasProgramadas() {
    theActorInTheSpotlight().attemptsTo(AdministrarFactura.conOpcionConsultarFacturasProgramadas());
  }
  ...
  public void deberiaVerDetalleFacturaProgramada() {
    theActorInTheSpotlight()
        .should(
            seeThat(VerificarConsultaDetalleFacturaProgramada.exitoso())
                .orComplainWith(
                    NoConsultaDetalleFacturaException.class, NO_CONSULTA_DETALLE_FACTURAS));
  }
  ...
  public void deberiaVerDetalleFacturaInscrita() {
    theActorInTheSpotlight()
        .should(
            seeThat(VerificarConsultaDetalleFacturaInscritas.inscritas())
                .orComplainWith(
                    NoConsultaDetalleFacturaException.class, NO_CONSULTA_DETALLE_FACTURAS));
  }
  ...
  public void deberiaVerSusFacturaInscrita() {
    theActorInTheSpotlight()
        .should(
            seeThat(VerificarConsultaFacturas.enFacturas())
                .orComplainWith(NoConsultaFacturaException.class, NO_CONSULTA_FACTURAS));
  }
}
