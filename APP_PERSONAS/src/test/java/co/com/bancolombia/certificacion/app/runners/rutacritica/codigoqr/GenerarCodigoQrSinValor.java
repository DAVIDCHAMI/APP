package co.com.bancolombia.certificacion.app.runners.rutacritica.codigoqr;
...
public class GenerarCodigoQrSinValor {
  public GenerarCodigoQrSinValor() {
  ...
  public static void test() throws InvalidFormatException, IOException {
    DataToFeature.overrideFeatureFiles(
        "./src/test/resources/features/codigoqr/generar_codigo_qr_sin_valor.feature");
  }
}
