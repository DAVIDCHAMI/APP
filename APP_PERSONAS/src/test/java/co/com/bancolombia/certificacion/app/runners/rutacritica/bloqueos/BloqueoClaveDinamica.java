package co.com.bancolombia.certificacion.app.runners.rutacritica.bloqueos;
...
public class BloqueoClaveDinamica {
  private BloqueoClaveDinamica() {
  ...
  public static void test() throws InvalidFormatException, IOException {
    DataToFeature.overrideFeatureFiles(
        "./src/test/resources/features/bloqueos/bloqueo_clave_dinamica.feature");
  }
}
