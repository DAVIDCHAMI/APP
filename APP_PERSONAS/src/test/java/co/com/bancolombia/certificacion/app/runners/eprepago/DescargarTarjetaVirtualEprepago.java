...
public class DescargarTarjetaVirtualEprepago {
  public DescargarTarjetaVirtualEprepago() {
  ...
  public static void test() throws InvalidFormatException, IOException {
    DataToFeature.overrideFeatureFiles(
        "./src/test/resources/features/eprepago/descargar_tarjeta_virtual_eprepago.feature");
  }
}
