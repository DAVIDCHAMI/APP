...
@CucumberOptions(
    features = {
      "src/test/resources/features/consultas/detalleproductos/consultar_detalle_cuentas_deposito.feature"
    },
    glue = {"co.com.bancolombia.certificacion.app.stepdefinitions"},
    snippets = SnippetType.CAMELCASE)
public class ConsultarDetalleCuentasDeposito {
  private ConsultarDetalleCuentasDeposito() {
