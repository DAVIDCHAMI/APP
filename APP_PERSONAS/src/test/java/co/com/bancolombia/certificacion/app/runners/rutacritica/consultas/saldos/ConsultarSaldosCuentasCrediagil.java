...
@CucumberOptions(
    features = {
      "src/test/resources/features/consultas/saldos/consultar_saldos_consolidados_crediagil.feature"
    },
    glue = {"co.com.bancolombia.certificacion.app.stepdefinitions"},
    tags = "@RutaCritica",
    snippets = SnippetType.CAMELCASE)
public class ConsultarSaldosCuentasCrediagil {
  private ConsultarSaldosCuentasCrediagil() {
