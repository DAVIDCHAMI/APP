...
@CucumberOptions(
    features = {
      "src/test/resources/features/consultas/saldos/consultar_saldos_consolidados_cuentas_deposito.feature"
    },
    glue = {"co.com.bancolombia.certificacion.app.stepdefinitions"},
    snippets = SnippetType.CAMELCASE)
public class ConsultarSaldosCuentasDeposito {
  private ConsultarSaldosCuentasDeposito() {
