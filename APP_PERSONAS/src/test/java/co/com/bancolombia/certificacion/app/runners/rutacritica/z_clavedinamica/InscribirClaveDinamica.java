...
@CucumberOptions(
        features = {"src/test/resources/features/z_clavedinamica/inscribir_clave_dinamica.feature"},
        glue = {"co.com.bancolombia.certificacion.app.stepdefinitions"},
        tags = "@RutaCritica",
        snippets = SnippetType.CAMELCASE
)
public class InscribirClaveDinamica {

    private InscribirClaveDinamica() {
        throw new IllegalStateException(CLASE_RUNNER);
    }

    @BeforeSuite
    public static void test() throws InvalidFormatException, IOException {
        DataToFeature.overrideFeatureFiles("./src/test/resources/features/z_clavedinamica/inscribir_clave_dinamica.feature");
    }
}
