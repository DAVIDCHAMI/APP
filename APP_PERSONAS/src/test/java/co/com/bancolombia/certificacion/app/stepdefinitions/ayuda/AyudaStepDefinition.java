...
public class AyudaStepDefinition {
  ...
  public void quiereIngresarOpcion(String opcionAyuda) {
    theActorInTheSpotlight().attemptsTo(AccederMenu.deAyuda(opcionAyuda));
  }

  @Y("^revisa avanza en onbording$")
  public void avanzaronboarding() {
    theActorInTheSpotlight().attemptsTo(RecorrerConoceNuestra.app());
  }
    ...
    theActorInTheSpotlight()
        .should(
            seeThat(Despliege.vista(mensajePantalla))
                .orComplainWith(PantallaSinDesplegar.class, NO_PRESENTA_MENSAJE));
  }
  ...
  public void deberiaVisualzoarMensajeEnlace(String tituloPantalla) {
    theActorInTheSpotlight()
        .should(
            seeThat(Visualizar.enlaceWeb(tituloPantalla))
                .orComplainWith(PantallaSinDesplegar.class, NO_PRESENTA_MENSAJE));
  }
}
