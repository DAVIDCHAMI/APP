...
public class GenerarCodigoQrStepDefinition {
  ...
  public void generarCodigoQrSinValor(List<Map<String, String>> datos) {
    theActorInTheSpotlight()
        .attemptsTo(
            GenerarCodigoQr.conInicioSesion(
                con()
                    .conTipoCuentaOrigen(datos)
                    .conNumeroCuentaOrigen(datos)
                    .conDescripcion(datos)));
  }
  ...
  public void generarCodigoQrSinIniciarSesionConValor(
      String nombrePersonalizado, List<Map<String, String>> datos) {
    theActorInTheSpotlight()
        .attemptsTo(
            GenerarCodigoQr.sinInciarSesion(
                nombrePersonalizado,
                con()
                    .conTipoCuentaOrigen(datos)
                    .conNumeroCuentaOrigen(datos)
  ...
  public void generarCodigoQrSinIniciarSesionSinValor(
      String nombrePersonalizado, List<Map<String, String>> datos) {
    theActorInTheSpotlight()
        .attemptsTo(
            GenerarCodigoQr.sinInciarSesion(
    ...
    theActorInTheSpotlight()
        .should(
            seeThat(VerificarGuardado.exitoso())
                .orComplainWith(
                    MensajeVerificacionNoPresentadoException.class,
                    NO_PRESENTA_MENSAJE_CONFIRMACION),
            seeThat(VerificarGeneracion.qr())
                .orComplainWith(
                    InformacionCodigoQrException.class, INFORMACION_CONFIRMACION_INCORRECTA));
  }
}
