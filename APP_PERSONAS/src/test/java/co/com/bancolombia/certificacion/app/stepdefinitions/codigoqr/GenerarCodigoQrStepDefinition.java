...
import co.com.bancolombia.certificacion.app.exceptions.codigoqr.InformacionCodigoQr;
import co.com.bancolombia.certificacion.app.exceptions.codigoqr.MensajeVerificacionNoPresentado;
...
import static co.com.bancolombia.certificacion.app.exceptions.codigoqr.InformacionCodigoQr.INFORMACION_CONFIRMACION_INCORRECTA;
import static co.com.bancolombia.certificacion.app.exceptions.codigoqr.MensajeVerificacionNoPresentado.NO_PRESENTA_MENSAJE_CONFIRMACION;
...
public class GenerarCodigoQrStepDefinition {
    ...
    public void deberiaVerMensajeConfirmacionCodigoQr() {
        theActorInTheSpotlight().should(
                seeThat(VerificarGuardado.exitoso()).orComplainWith(MensajeVerificacionNoPresentado.class, NO_PRESENTA_MENSAJE_CONFIRMACION),
                seeThat(VerificarGeneracion.qr()).orComplainWith(InformacionCodigoQr.class, INFORMACION_CONFIRMACION_INCORRECTA)
        );
    }
}
