...
public class DescargarTarjetaVirtualEprepagoStepDefinition {
  ...
  public void descargarTarjetaVirtualEPrepago(
      String valorDescarga, List<Map<String, String>> productoDestino) {
    theActorInTheSpotlight()
        .attemptsTo(
            DescargarSaldo.deLaTarjetaCon(
                elProducto().conProductoDebitar(productoDestino), valorDescarga));
  }
  ...
  public void deberiaVerMensajeDescargaTarjetaVritualEPrepagoExitosa() {
    theActorInTheSpotlight()
        .should(
            seeThat(DescargaTarjetaVirtualEprepago.esExitosa())
                .orComplainWith(
                    NoSeRealizoLaDescargaExitosaException.class,
                    MENSAJE_DESCARGA_EPREPAGO_NO_EXITOSA));
  }
}
