...
public class ConsultarProductosAsociadosStepDefinition {
  ...
  @Cuando(
      "^quiero revisar mis movimientos de cuenta deposito en la app con tipo de cuenta (.*) y numero cuenta (.*)$")
  public void revisarMisMovimientosCuentasEnlaApps(String tipoCuenta, String numeroCuenta) {
    theActorInTheSpotlight().attemptsTo(ConsultarMovimientos.deCuentas(tipoCuenta, numeroCuenta));
  }

  @Cuando(
      "^quiero revisar mis movimientos de inversiones con tipo de cuenta (.*) y numero cuenta (.*)$")
  public void revisarMisMovimientosInversiones(String tipoCuenta, String numeroCuenta) {
    theActorInTheSpotlight()
        .attemptsTo(ConsultarMovimientos.deInversiones(tipoCuenta, numeroCuenta));
  }

  @Cuando(
      "^quiero revisar mis movimientos de tarjeta de credito en la app con tipo de cuenta (.*) y numero cuenta (.*)$")
  public void revisarMisMovimientosTarjetaEnlaApps(String tipoCuenta, String numeroCuenta) {
    theActorInTheSpotlight()
        .attemptsTo(ConsultarMovimientos.deTarjetasCredito(tipoCuenta, numeroCuenta));
  }

  @Cuando(
      "^quiero revisar mis movimientos de eprepago en la app con tipo de cuenta (.*) y numero cuenta (.*)$")
  public void revisarMisMovimientosEprepago(String tipoCuenta, String numeroCuenta) {
    theActorInTheSpotlight().attemptsTo(ConsultarMovimientos.deEprepago(tipoCuenta, numeroCuenta));
  }

  @Cuando(
      "^quiero filtrar mis movimientos de eprepago por descripcion (.*) en la app con tipo de cuenta (.*) y numero cuenta (.*)$")
  public void quieroFiltrarMisMovimientosDeEprepagoPorDescripcionEnLaApp(
      String descripcionMovimiento, String tipoCuenta, String numeroCuenta) {
    theActorInTheSpotlight()
        .attemptsTo(
            ConsultarMovimientos.porDescripcionDeEprepago(
                descripcionMovimiento, tipoCuenta, numeroCuenta));
  }

  @Cuando(
      "^quiero filtrar mis movimientos de eprepago por rango de fechas (.*) en la app con tipo de cuenta (.*) y numero cuenta (.*)$")
  public void quieroFiltrarMisMovimientosDeEprepagoPorRangoDeFechasEnLaApp(
      String rangoFechas, String tipoCuenta, String numeroCuenta) {
    theActorInTheSpotlight()
        .attemptsTo(ConsultarMovimientos.porRangoDeFechas(rangoFechas, tipoCuenta, numeroCuenta));
  }

  @Y("el ingresa a sus productos$")
  public void ingresaSusProductos() {
    theActorInTheSpotlight().attemptsTo(GuardarDatos.deProductos());
  }
  ...
  public void deberiaVerUnicamenteCuentasDeposito() {
    theActorInTheSpotlight()
        .should(
            seeThat(VerificarCuentasDeposito.comoUnicoProducto())
                .orComplainWith(
                    NoPoseeSoloCuentasDepositoException.class,
                    MENSAJE_NO_TIENE_UNICAMENTE_CUENTAS_DEPOSITO));
  }
  ...
  public void deberiaVerMovimientosAsociadosSuCuenta() {
    theActorInTheSpotlight()
        .should(
            seeThat(VerificarMovimientos.productos())
  ...
  public void deberiaVerProductosAsociadosSuCuenta() {
    theActorInTheSpotlight()
        .should(
            seeThat(RevisarProductos.pertenecientesAlUsuario())
                .orComplainWith(
  ...
  public void deberiaVerLosMovimientosNingunMovimientoConLaTarjeta(String mensaje) {
    theActorInTheSpotlight()
        .should(
            seeThat(VerificarProducto.sinMovimientos(mensaje))
