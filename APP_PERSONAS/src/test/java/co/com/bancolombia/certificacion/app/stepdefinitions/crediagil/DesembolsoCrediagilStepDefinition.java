...
public class DesembolsoCrediagilStepDefinition {
  ...
  public void realizarDesembolsoCrediagil(
      String valorDesembolso, String tipoCuenta, String numeroCuenta) {
    theActorInTheSpotlight()
        .attemptsTo(
            Desembolsar.crediagil(
                valorDesembolso, elProducto().conTipoCuenta(tipoCuenta).conNumero(numeroCuenta)));
  }

  @Cuando(
      "^realiza el desembolso fuera del rango de su crediagil por valor (.*) a la cuenta (.*) numero (.*)$")
  public void realizarDesembolsoCrediagilFueraRango(
      String valorDesembolso, String tipoCuenta, String numeroCuenta) {
    theActorInTheSpotlight()
        .attemptsTo(
            DesembolsarCreadiagil.fueraRango(
                valorDesembolso, elProducto().conTipoCuenta(tipoCuenta).conNumero(numeroCuenta)));
  }
  ...
  public void deberiaVerMensajeDesembolsoCorrecto() {
    theActorInTheSpotlight()
        .should(
            seeThat(DesembolsoCrediagil.exitoso())
  ...
  public void deberiaVerMensajeValorFueraRango() {
    theActorInTheSpotlight()
        .should(
            seeThat(DesembolsoCrediagilFuera.rango())
                .orComplainWith(
                    DesembolsoCrediagilFueraRangoException.class, PERMITE_AVANZAR_DESEMBOLSO));
  }
}
