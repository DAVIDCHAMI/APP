...
public class RegistroUsuarioStepDefinition {
  ...
  public void quiereIngresarARegistrarseConElDocumentoConClave(
  ...
  public void quiereRealizarElRegistroConElUsuarioYConElCorreo(
      String nuevoUser, String correoUser) {
  ...
  public void elDeberiaDeVerElMensajeUsuarioOClaveInvalida() {
    theActorInTheSpotlight()
        .should(
            seeThat(MensajeUsuarioYaRegistrado.esVisible())
                .orComplainWith(
  ...
  public void quiereRealizarElRegistroDespues() {
    theActorInTheSpotlight().attemptsTo(Registrar.nuevamenteUsuario());
  }
  ...
  public void mostrarseVerLaPantallaDeRegistro() {
    theActorInTheSpotlight()
        .should(
            seeThat(VerificarPantalla.inicioRegistro())
                .orComplainWith(
                    PantallaRegistroNoPresenteException.class,
                    MENSAJE_PANTALLA_REGISTRO_NO_VISIBLE));
  }
}
