...
public class SolicitarTarjetaVirtualEprepagoStepDefinition {
  ...
  public void deboVerElMensajeDeSolicitudExitosa() {
    theActorInTheSpotlight()
        .should(
            seeThat(SolicitudTarjetaVirtualEprepago.esExitosa())
                .orComplainWith(
                    NoSeRealizoSolicitudEprepagoException.class, MENSAJE_E_PREPAGO_NO_SOLICITADA));
  }
  ...
  public void deboVerElMensajeRespectivoParaElUsuario() {
    theActorInTheSpotlight()
        .should(
            seeThat(UsuarioConEprepago.enLaApp())
                .orComplainWith(
                    NoSeRealizoLaConsultaException.class, MENSAJE_CONSULTA_NO_REALIZADA));
  }
}
