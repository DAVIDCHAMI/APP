package co.com.bancolombia.certificacion.app.runners.rutacritica.avancestarjetacredito;
...
public class EnviarDineroTarjetaCredito {
  ...
  public static void test() throws InvalidFormatException, IOException {
    DataToFeature.overrideFeatureFiles(
        "./src/test/resources/features/avancestarjetacredito/avances_enviar_dinero.feature");
  }
}
