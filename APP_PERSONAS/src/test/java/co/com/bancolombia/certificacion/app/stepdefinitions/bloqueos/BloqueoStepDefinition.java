...
public class BloqueoStepDefinition {
  ...
  public void bloquearClave() {
    theActorInTheSpotlight().attemptsTo(Bloquear.clave());
  }

  @Cuando("^quiere bloquear la clave y tarjetas$")
  public void bloquearClaveTarjteas() {
    theActorInTheSpotlight().attemptsTo(Bloquear.claveTarjetas());
  }

  @Cuando("^quiere bloquear la clave dinamica$")
  public void bloquearClaveDinamica() {
    theActorInTheSpotlight().attemptsTo(Bloquear.claveDinamica());
  }
  ...
  public void verMensajeBloqueoExitoso() {
    theActorInTheSpotlight()
        .should(
            seeThat(VerificarBloqueo.exitoso())
                .orComplainWith(MensajeBloquoNoPresentadoException.class, MENSAJE_NO_PRESENTADO));
  }
}
