package co.com.bancolombia.certificacion.app.runners.completa.administrarfacturas;
...
public class EliminarProgramacion {
  ...
  public static void test() throws InvalidFormatException, IOException {
    DataToFeature.overrideFeatureFiles(
        "./src/test/resources/features/administrarfacturas/eliminar_factura.feature");
  }
}
