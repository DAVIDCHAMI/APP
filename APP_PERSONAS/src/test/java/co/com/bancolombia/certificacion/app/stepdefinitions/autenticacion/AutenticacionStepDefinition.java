...
public class AutenticacionStepDefinition {
  ...
  public void verificoElResultadoDeLaAutenticacionExitosa() {
    theActorInTheSpotlight()
        .should(
            seeThat(MensajeClaveValida.esVisible())
                .orComplainWith(
                    MensajeValidacionNoVisualizadoException.class,
                    MENSAJE_VALIDACION_NO_ENCONTRADO));
  }
  ...
  public void verificoElResultadoDelLogueoFallido() {
    theActorInTheSpotlight()
        .should(
            seeThat(MensajeClaveInvalida.esVisible())
                .orComplainWith(
                    MensajeClaveInvalidoNoVisualizadoException.class,
                    MENSAJE_PASS_INVALIDO_NO_ENCONTRADO));
  }
  ...
  public void verificoElResultadoDelLogueoConUsuarioBloqueado() {
    theActorInTheSpotlight()
        .should(
            seeThat(MensajeDeClaveBloqueada.esVisible())
                .orComplainWith(
                    MensajeClaveBloqueadaNoVisualizadoException.class,
                    MENSAJE_CLAVE_BLOQUEADA_NO_ENCONTRADO));
  }
  ...
  public void seDebePresentarLaFraseDeSeguridadAsociadaAlUsuario() {
    theActorInTheSpotlight()
        .should(
            seeThat(VerificarFrase.deSeguridadDelUsuario())
  ...
  public void seDebePresentarUnaFraseDeSeguridadAsociadaAlUsuarioInexistente() {
    theActorInTheSpotlight()
        .should(
            seeThat(FraseDeSeguridad.usuarioInexistente())
                .orComplainWith(FraseDeSeguridadException.class, FRASE_DE_SEGURIDAD_NO_VISIBLE));
  }
  ...
  public void laFraseDeSeguridadNoSeDebeVisualizar() {
    theActorInTheSpotlight()
        .should(
            seeThat(FraseSeguridad.noVisible())
  ...
  public void seDebenDeVerLasOpcionesParaUnClienteNuevo() {
    theActorInTheSpotlight()
        .should(
            seeThat(VerificarOpcion.aunNoEresCliente())
                .orComplainWith(
                    OpcionAunNoEresClienteException.class, OPCION_AUN_NO_ERES_CLIENTE_NO_VISIBLE));
  }
}
