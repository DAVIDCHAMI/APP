...
public class PagarFacturasStepDefinition {
  ...
  public void elActorPagaSusFacturasProgramadas(String opcion, List<Map<String, String>> datos) {
    theActorInTheSpotlight()
        .attemptsTo(
            AdministrarFactura.conOpcionPagarProgramadas(
                opcion,
                factura()
                    .conValor(datos)
  ...
  public void elActorPagaSusFacturasInscritaConOpcion(
      String opcion, List<Map<String, String>> datos) {
    theActorInTheSpotlight()
        .attemptsTo(
            AdministrarFactura.conOpcionPagarVariasInscritas(
                opcion,
                factura()
                    .conValor(datos)
                    .conEmpresaServicio(datos)
  ...
  public void elActorPagaSusFacturasInscritas(List<Map<String, String>> datos) {
    theActorInTheSpotlight()
        .attemptsTo(
            AdministrarFactura.conOpcionPagarInscritas(
                factura()
                    .conValor(datos)
                    .conEmpresaServicio(datos)
                    .conProducto(datos)
  ...
  public void elActorPagaSusFacturasRedeban(List<Map<String, String>> datos) {
    theActorInTheSpotlight()
        .attemptsTo(
            AdministrarFactura.pagoRedeban(
                factura()
                    .conValor(datos)
                    .conEmpresaServicio(datos)
                    .conProducto(datos)
  ...
  public void deberiaVerPagoRedeban() {
    theActorInTheSpotlight()
        .should(
            seeThat(VerificarPago.redeban())
                .orComplainWith(PagoRedebanNoRealizadoException.class, PAGO_REDEBAN_NO_REALIZADO));
  }
  ...
  public void deberiaVerPagoDeFacturaProgramada() {
    theActorInTheSpotlight()
        .should(
            seeThat(VerificarPagoFactura.programada())
                .orComplainWith(PagoRedebanNoRealizadoException.class, PAGO_REDEBAN_NO_REALIZADO));
  }
  ...
  public void deberiaVerHPagoFacturaInscrita() {
    theActorInTheSpotlight()
        .should(
            seeThat(VerificarPagoFacturaInscrita.factura())
                .orComplainWith(PagoFacturaInscritaException.class, NO_SE_PAGO_FACTURA_INSCRITA));
  }
}
