...
public class InactivarEprepagoStepDefinition {
  ...
  public void elDeberiaDeVerUnMensajeDeInactivacionExitosaParaSuEprepago() {
    theActorInTheSpotlight()
        .should(
            seeThat(InactivacionEprepago.exitosa())
                .orComplainWith(
                    InactivacionEprepagoNoRealizadaException.class, NO_SE_REALIZO_INACTIVACION));
  }
  ...
  public void mensajeNumeroMaximoIntentosInactivacion() {
    theActorInTheSpotlight()
        .should(
            seeThat(NumeroMaximoIntentosInactivacion.ePrepago())
                .orComplainWith(
                    NoPresentaMensajeNumeroMaximoInactivacionesException.class,
                    NO_PRESENTA_MENSAJE_NUMERO_MAXIMO_INACTIVACIONES));
  }
}
