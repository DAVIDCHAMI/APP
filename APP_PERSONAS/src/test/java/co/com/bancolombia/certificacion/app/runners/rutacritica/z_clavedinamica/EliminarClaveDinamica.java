...
@CucumberOptions(
        features = {"src/test/resources/features/z_clavedinamica/eliminar_clave_dinamica.feature"},
...
public class EliminarClaveDinamica {
    ...
    public static void test() throws InvalidFormatException, IOException {
        DataToFeature.overrideFeatureFiles("./src/test/resources/features/z_clavedinamica/eliminar_clave_dinamica.feature");
    }
}