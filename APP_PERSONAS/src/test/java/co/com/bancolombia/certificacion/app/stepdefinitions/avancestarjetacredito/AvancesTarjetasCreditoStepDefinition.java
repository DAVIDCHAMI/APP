...
import static co.com.bancolombia.certificacion.app.tasks.avancestarjetacredito.EnviarDinero.SeleccionaProductoOrigen;
...
public class AvancesTarjetasCreditoStepDefinition
{
    ...
    {
        theActorInTheSpotlight().attemptsTo(SeleccionaProductoOrigen(tarjetaCredito().conDatosDeTarjeta(datos)));
    }
}
