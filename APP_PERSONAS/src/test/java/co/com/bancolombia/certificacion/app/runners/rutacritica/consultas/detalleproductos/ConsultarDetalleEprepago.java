...
@CucumberOptions(
    features = {
      "src/test/resources/features/consultas/detalleproductos/consultar_detalle_eprepago.feature"
    },
    glue = {"co.com.bancolombia.certificacion.app.stepdefinitions"},
    tags = "@RutaCritica",
    snippets = SnippetType.CAMELCASE)
public class ConsultarDetalleEprepago {
  private ConsultarDetalleEprepago() {
