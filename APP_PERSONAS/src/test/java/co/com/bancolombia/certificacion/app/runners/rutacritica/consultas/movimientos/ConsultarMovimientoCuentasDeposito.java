...
@CucumberOptions(
    features = {
      "src/test/resources/features/consultas/movimientos/consultar_movimientos_cuentas_deposito.feature"
    },
    glue = {"co.com.bancolombia.certificacion.app.stepdefinitions"},
    tags = "@RutaCritica",
    snippets = SnippetType.CAMELCASE)
public class ConsultarMovimientoCuentasDeposito {
  private ConsultarMovimientoCuentasDeposito() {
