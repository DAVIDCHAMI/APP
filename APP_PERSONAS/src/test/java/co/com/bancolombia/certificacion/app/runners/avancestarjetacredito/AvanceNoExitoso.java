...
@CucumberOptions(
        features = {"src/test/resources/features/avancestarjetacredito/avances_no_exitosos.feature"},
        glue = {"co.com.bancolombia.certificacion.app.stepdefinitions"},
        snippets = SnippetType.CAMELCASE
)

public class AvanceNoExitoso
{
    private AvanceNoExitoso() {throw new IllegalStateException(CLASE_RUNNER);}

    @BeforeSuite
    public static void test() throws InvalidFormatException, IOException {
        DataToFeature.overrideFeatureFiles("./src/test/resources/features/avancestarjetacredito/avances_no_exitosos.feature");
    }
}
