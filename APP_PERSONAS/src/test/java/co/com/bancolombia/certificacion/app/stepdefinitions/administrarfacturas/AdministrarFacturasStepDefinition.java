...
public class AdministrarFacturasStepDefinition {
  ...
  public void programaSusFacturasInscritasConInformacion(List<Map<String, String>> datos) {
    theActorInTheSpotlight()
        .attemptsTo(
            AdministrarFactura.conOpcionProgramar(
                factura()
                    .conValor(datos)
  ...
  public void revisaelHistoricoDeSuFacturasInscritas(
      String opcion, List<Map<String, String>> datos) {
    theActorInTheSpotlight()
        .attemptsTo(
            AdministrarFactura.conHistoricoPago(
                opcion,
                factura().conValor(datos).conFechaFactura(datos).conEmpresaServicio(datos)));
  }
  ...
  public void modifcaDescripcionFacturasInscritas(List<Map<String, String>> datos) {
    theActorInTheSpotlight()
        .attemptsTo(
            AdministrarFactura.conOpcionEditarFacturaInscrita(
                factura()
                    .conValor(datos)
                    .conFechaFactura(datos)
                    .conEmpresaServicio(datos)
  ...
  public void eliminaSusFacturasInscritas(String opcion, List<Map<String, String>> datos) {
    theActorInTheSpotlight()
        .attemptsTo(
            AdministrarFactura.conOpcionELiminar(
                factura().conValor(datos).conFechaFactura(datos).conEmpresaServicio(datos),
                opcion));
  }

  @Cuando("el actor modifica sus facturas programadas por la opcion (.*)$")
  public void elActorModificaSusFacturasProgramadas(
      String opcion, List<Map<String, String>> datos) {
    theActorInTheSpotlight()
        .attemptsTo(
            AdministrarFactura.conOpcionEditar(
                factura()
                    .conValor(datos)
                    .conFechaFactura(datos)
                    .conFechaInicio(datos)
  ...
  public void deberiaModificacionExitosa() {
    theActorInTheSpotlight()
        .should(
            seeThat(VerificarModificacionFacturaInscrita.exitoso())
  ...
  public void deberiaVerMensajeModificacionExitosa() {
    theActorInTheSpotlight()
        .should(
            seeThat(VerificarModificacionFacturaProgramadas.programadas())
                .orComplainWith(ModificacionProgramacionException.class, MENSAJE_MODIFICACION));
  }
  ...
  public void mensajeEliminacionExitosa() {
    theActorInTheSpotlight()
        .should(
            seeThat(VerificarEliminacionFactura.exitoso())
                .orComplainWith(EliminacionFacturasException.class, MENSAJE_ELIMINACION));
  }
  ...
  public void deberiaVisualzoarMensajeEnlace() {
    theActorInTheSpotlight()
        .should(
            seeThat(VerificarInscripcion.factura())
                .orComplainWith(VerificarInscripcionFactura.class, INSCRIPCION_FALLIDA));
  }
  ...
  public void deberiaVerHistoricoPago() {
    theActorInTheSpotlight()
        .should(
            seeThat(VerificarHistoricoPago.enFacturas())
                .orComplainWith(HistoricoPagoException.class, NO_TIENE_HISTORICO_DE_PAGOS));
  }
  ...
  public void deberiaVerMensajeProgramacionExitosa() {
    theActorInTheSpotlight()
        .should(
            seeThat(VerificarProgramacion.deFactura())
                .orComplainWith(
                    NoPresentaMensajeProgramacionExitosaException.class,
                    NO_PRESENTA_MENSAJE_PROGRAMACION_EXITOSA));
  }
}
