...
public class InscripcionProductosStepDefinition {
  ...
  public void quieroRealizarInscripcionProductosConInformacion(List<String> datos) {
    theActorInTheSpotlight()
        .attemptsTo(InscribirProductos.conInformacion(inscripcionProductos(datos)));
  }
  ...
  public void quieroRealizarInscripcionProductos(String mensaje) {
    theActorInTheSpotlight()
        .should(
            seeThat(VerificarInscripcionExistente.deProductos(mensaje))
                .orComplainWith(
                    ProductoPenditeteActivacionException.class,
                    NO_RECONOCE_PRODUCTO_PENDIENTE_ACTIVACION));
  }
  ...
  public void deberiaVerDetalleProductoRegistrado() {
    theActorInTheSpotlight()
        .should(
            seeThat(VerificarInscripcion.deProductos())
                .orComplainWith(NoSeInscribioProductoException.class, PRODUCTO_NO_INSCRITO));
  }
}
