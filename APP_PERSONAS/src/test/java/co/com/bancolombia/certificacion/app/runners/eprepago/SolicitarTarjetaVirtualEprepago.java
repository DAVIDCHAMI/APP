...
public class SolicitarTarjetaVirtualEprepago {

  public SolicitarTarjetaVirtualEprepago() {
  ...
  public static void test() throws InvalidFormatException, IOException {
    DataToFeature.overrideFeatureFiles(
        "./src/test/resources/features/eprepago/solicitar_tarjeta_virtual_eprepago.feature");
  }
}
