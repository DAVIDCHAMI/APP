...
@CucumberOptions(
    features = {
      "src/test/resources/features/transferencia/transferencia_productos_propios.feature"
    },
    glue = {"co.com.bancolombia.certificacion.app.stepdefinitions"},
    tags = "@RutaCritica",
    snippets = SnippetType.CAMELCASE)
public class TransferenciaProductosPropios {

  public TransferenciaProductosPropios() {
