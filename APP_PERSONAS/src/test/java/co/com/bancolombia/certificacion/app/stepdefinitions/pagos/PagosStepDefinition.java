...
public class PagosStepDefinition {
  ...
  public void pagoTarjetaCreditoNoPropia(List<Map<String, String>> datos) {
    theActorInTheSpotlight()
        .attemptsTo(
            Pagar.tarjetaCreditoNoPropia(
                tarjetaCredito()
                    .conTarjeta(datos)
                    .conTipoPago(datos)
                    .conMoneda(datos)
                    .conValor(datos),
                elProducto().conProductoDebitar(datos)));
  }
  ...
  public void pagoTarjetaCreditoPropiaMayorDeuda(List<Map<String, String>> datos) {
    theActorInTheSpotlight()
        .attemptsTo(
            Pagar.tarjetaCreditoPropiaMayorDeuda(
                tarjetaCredito()
                    .conTarjeta(datos)
                    .conTipoPago(datos)
                    .conMoneda(datos)
  ...
  public void pagoCreditos(List<Map<String, String>> datos) {
    theActorInTheSpotlight()
        .attemptsTo(
            Pagar.creditos(
                credito().conCredito(datos).conTipoPago(datos).conValor(datos),
                elProducto().conProductoDebitar(datos)));
  }
    ...
    theActorInTheSpotlight()
        .should(
            seeThat(VerificarPago.exitoso())
                .orComplainWith(PagoNoRealizadoException.class, PAGO_NO_REALIZADO));
  }
  ...
  public void verMensajeValorMayorDeduda() {
    theActorInTheSpotlight()
        .should(
            seeThat(VerificarMensajePagoMayor.aDeuda())
                .orComplainWith(MensajeNoPresentadoException.class, MENSAJE_NO_PRESENTADO));
  }
