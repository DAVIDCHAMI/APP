...
public class TransferenciaStepDefinition {
  ...
  public void diligenciaDatosDeTransferencia(
      String tipoProductoOrigen, String tipoProductoDestino, List<Map<String, String>> datos) {
        ...
        .attemptsTo(
            RealizarTransferencia.conInfo(
                con()
                    ...
                    .conNumeroCuentaDestino(datos)
                    .conTipoCuentaDestino(datos)
                    .conMonto(datos),
                tipoProductoOrigen,
                tipoProductoDestino));
  }
  ...
  public void deberiaVerConfirmacionExitosaDeTransferencia() {
    theActorInTheSpotlight()
        .should(
            seeThat(VerificarTransferencia.exitosa())
                .orComplainWith(TransferenciaFallida.class, TRANSFERENCIA_FALLIDA));
  }
  ...
  public void deberiaVerMensajePagoCuentaSinSaldo() {
    theActorInTheSpotlight()
        .should(
            seeThat(VerificarMensajeSin.saldo())
                .orComplainWith(
                    MensajeCuentaSinSaldoException.class, MENSAJE_CUENTA_SIN_SALDO_NO_PRESENTADO));
  }
}
