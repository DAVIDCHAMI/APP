package co.com.bancolombia.certificacion.app.runners.rutacritica.transferencia;
...
@CucumberOptions(
    features = {
      "src/test/resources/features/transferencia/transferencia_productos_no_inscritos.feature"
    },
    glue = {"co.com.bancolombia.certificacion.app.stepdefinitions"},
    tags = "@RutaCritica",
    snippets = SnippetType.CAMELCASE)
public class TransferenciaProductosNoInscritos {

  public TransferenciaProductosNoInscritos() {
