...
public class ConsultarMovimientos {
  ...
  public static Performable deTarjetasCredito(String tipoCuenta, String numeroCuenta) {
    return instrumented(
        ConsultarMovimientosTarjetasInversiones.class,
        tipoCuenta,
        numeroCuenta,
        TARJETAS_CREDITO.getCategoria());
  }
  ...
  public static Performable porDescripcionDeEprepago(
      String descripcionMovimientos, String tipoCuenta, String numeroCuenta) {
    return instrumented(
        ConsultarMovimientosEprepagoPorDescripcion.class,
        descripcionMovimientos,
        tipoCuenta,
        numeroCuenta);
  }

  public static Performable porRangoDeFechas(
      String rangoFechas, String tipoCuenta, String numeroCuenta) {
    return instrumented(
        ConsultarMovimientosEprepagoPorRangosDeFecha.class, rangoFechas, tipoCuenta, numeroCuenta);
  }
}
