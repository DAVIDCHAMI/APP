...
import static co.com.bancolombia.certificacion.app.userinterface.pages.comunes.GeneralPage.BTN_PAGAR;
    ...
    actor.attemptsTo(
        ...
        WaitUntil.the(
            OPT_PAGAR_FACTURA_PROGRAMADA.of(
                factura.getValorFactura(), factura.getFechaFactura(), factura.getEmpresaServicio()),
            isPresent()),
        ...
        Click.on(
            OPT_CUENTA_PRODUCTO.of(
                factura.getProducto().getTipo(), factura.getProducto().getNumero())),
        Validar.carga(),
        Check.whether(opcion.contains(SELECCIONAR_TODAS))
            .andIfSo(
