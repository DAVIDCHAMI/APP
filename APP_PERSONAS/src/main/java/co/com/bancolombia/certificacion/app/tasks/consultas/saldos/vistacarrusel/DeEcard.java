...
public class DeEcard implements Task {
  ...
  public <T extends Actor> void performAs(T actor) {
    ...
    while (elementoPresente(
        actor, LBL_DEUDA_PESOS_TC_VISTA_CARRUSEL.of(String.valueOf(iterador)))) {
      actor.attemptsTo(Scroll.to(LBL_DEUDA_PESOS_TC_VISTA_CARRUSEL.of(String.valueOf(iterador))));
      iterador = iterador + 1;
    }
    actor.attemptsTo(Click.on(LBL_VER_DETALLE_ECARD_TDC_CARRUSEL));
    actor.remember(
