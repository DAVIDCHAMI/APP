...
public class QueryManager {
  public static final ResourceBundle CONSULTAS =
      ResourceBundle.getBundle("queries/iseries/consultas");
  public static final ResourceBundle ORACLE_BATCH =
      ResourceBundle.getBundle("queries/oracle/consultasOracle");
