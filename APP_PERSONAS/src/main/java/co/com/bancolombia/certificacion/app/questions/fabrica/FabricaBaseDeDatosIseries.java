...
public class FabricaBaseDeDatosIseries {
  ...
  public static Question<Boolean> elArchivoEnIseriesPCCFFLOGTFtarjetasCredito() {
    return new ConsultarConsolidadoTarjetasCredito();
  }

  public static Question<Boolean> elArchivoEnIseriesCXREFCNAMEtarjetasCredito() {
    return new ConsultarPertenenciaTarjetasCredito();
  }

  public static Question<Boolean> elArchivoEnIseriesENCARC() {
    return new ConsultarConsolidadoFiducias();
  }

  public static Question<Boolean> elArchivoEnIseriesCABFFTARJeprepago() {
    return new ConsultarEprepagoEnCABFFTARJ();
  }
}
