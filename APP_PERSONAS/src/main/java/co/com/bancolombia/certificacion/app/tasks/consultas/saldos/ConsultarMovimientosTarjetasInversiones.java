...
public class ConsultarMovimientosTarjetasInversiones implements Task {
  ...
  public ConsultarMovimientosTarjetasInversiones(
      String tipoCuenta, String numeroCuenta, String opcionCategoria) {
  ...
  public <T extends Actor> void performAs(T actor) {
    ...
    while (Verificar.elementoVisible(
        actor, CONTENEDOR_MOVIMIENTOS_TARJETA.of(String.valueOf(iterador)))) {
      listaMovimiento.add(
          movimiento()
              .conFecha(
                  LBL_FECHA_MOVIMIENTO_TARJETA_CREDITO
                      .of(String.valueOf(iterador))
                      .resolveFor(actor)
                      .getText())
              .conDescripcion(
                  LBL_DESCRIPCION_MOVIMIENTO_TARJETA_CREDITO
                      .of(String.valueOf(iterador))
                      .resolveFor(actor)
                      .getText())
              .conValorMovimiento(
                  LBL_SALDO_MOVIMIENTO_TARJETA_CREDITO
                      .of(String.valueOf(iterador))
                      .resolveFor(actor)
                      .getText())
              .build());
