...
public class ListarTarjetasBilleteraLocator {
    ...
    public static final Locator IMG_TARJETA_LISTA_ELEGIR_LOCATOR = locator().withAndroid("xpath$f").withIos("xpath$d");
    public static final Locator BTN_QR_LISTA_LOCATOR = locator().withAndroid("xpath$f").withIos("xpath$d");
    public static final Locator LBL_SALDO_DISPONIBLE_LISTA_LOCATOR = locator().withAndroid("xpath$f").withIos("xpath$d");
    public static final Locator IMG_TARJETA_CARRUSEL_ELEGIR_LOCATOR = locator().withAndroid("xpath$f").withIos("xpath$d");
    public static final Locator BTN_QR_CARRUSEL_LOCATOR = locator().withAndroid("xpath$f").withIos("xpath$d");
    public static final Locator LBL_SALDO_DISPONIBLE_CARRUSEL_LOCATOR = locator().withAndroid("xpath$f").withIos("xpath$d");
