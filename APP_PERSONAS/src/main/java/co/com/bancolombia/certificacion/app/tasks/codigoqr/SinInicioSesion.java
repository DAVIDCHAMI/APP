...
public class SinInicioSesion extends GenerarQR {
  ...
  public <T extends Actor> void performAs(T actor) {
    actor.attemptsTo(
        ...
        Click.on(LNK_SIGUIENTE),
        Check.whether("".equals(transferencia.getMonto()))
    ...
    if ("".equals(transferencia.getMonto())) transferencia.setMonto(SIN_VALOR);
    else transferencia.setMonto(darFormato(transferencia.getMonto()));
