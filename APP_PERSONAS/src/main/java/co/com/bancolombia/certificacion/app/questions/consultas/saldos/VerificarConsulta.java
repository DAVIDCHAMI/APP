...
public class VerificarConsulta implements Question<Boolean> {
    ...
    public Boolean answeredBy(Actor actor) {
        ...
        return  listaTC.get(0).getTipoTarjeta().equalsIgnoreCase(datosTC.get(0).get("tipoTarjeta")) &&
                ...
                listaTC.get(0).getDeudaALaFechaEnPesos().equalsIgnoreCase(datosTC.get(0).get("deudaPesos")) &&
                listaTC.get(0).getDeudaTotalEnDolares().equalsIgnoreCase(datosTC.get(0).get("deudaDolares"));
    }
