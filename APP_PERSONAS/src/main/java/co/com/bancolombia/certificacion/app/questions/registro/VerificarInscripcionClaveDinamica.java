...
import static co.com.bancolombia.certificacion.app.userinterface.pages.registro.InscripcionClaveDinamicaPage.COMPROBANTE_CLAVE_DINAMICA;
...
public class VerificarInscripcionClaveDinamica implements Question<Boolean> {
    ...
    public Boolean answeredBy(Actor actor) {
        ...
        return (Visibility.of(COMPROBANTE_CLAVE_DINAMICA).viewedBy(actor).asBoolean() &&
