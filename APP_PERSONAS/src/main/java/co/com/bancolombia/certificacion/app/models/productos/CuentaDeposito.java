...
public class CuentaDeposito extends Producto {
  ...
  public void setTipoCuentaEnLetras(String tipoCuentaEnLetras) {
    if (tipoCuentaEnLetras.equalsIgnoreCase(AHORRO.getLetra())
        || tipoCuentaEnLetras.equalsIgnoreCase(CORRIENTE.getLetra())) {
  ...
  public void setTipoCuentaEnNumeros(String tipoCuentaEnNumeros) {
    if (tipoCuentaEnNumeros.equalsIgnoreCase(CORRIENTE.getNumero())
        || tipoCuentaEnNumeros.equalsIgnoreCase(AHORRO.getNumero())) {
      this.tipoCuentaEnNumero = tipoCuentaEnNumeros;
    } else {
      this.tipoCuentaEnNumero =
          AdministradorUtilidades.formatoTipoCuentaNumero(tipoCuentaEnNumeros);
    }
  }
  ...
  public void setNumeroCuentaFormateado(String accountNumberFormat) {
    this.numeroCuentaFormateado =
        AdministradorUtilidades.formatoCuentaDeposito(accountNumberFormat);
  }
