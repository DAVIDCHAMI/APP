...
public class TransferenciaPage {
    ...
    public static final Target TXT_NUMERO_CUENTA_DESTINO = Target.the("Número de cuenta destino").located(theElementBy(TXT_NUMERO_CUENTA_DESTINO_LOCATOR));
    ...
    public static final Target CHK_TIPO_CUENTA = Target.the("Selecciona el tipo cuenta").locatedBy(dynamicElement(CHK_TIPO_LOCATOR));
