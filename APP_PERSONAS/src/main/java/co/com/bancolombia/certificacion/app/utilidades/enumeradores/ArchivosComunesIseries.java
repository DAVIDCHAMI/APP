...
public enum ArchivosComunesIseries {
    ...
    PCCFFLOGTF_TDCCONSOLIDADO(FabricaBaseDeDatosIseries.elArchivoEnIseriesPCCFFLOGTFcreditCards(), AfirmacionDelProducto.class, AfirmacionDelProducto.NO_FUNCIONA),
