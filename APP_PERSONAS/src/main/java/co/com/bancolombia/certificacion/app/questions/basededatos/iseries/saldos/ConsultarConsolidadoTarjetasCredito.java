...
public class ConsultarConsolidadoTarjetasCredito implements Question<Boolean> {
  ...
  private static final Logger LOGGER =
      LogManager.getLogger(ConsultarConsolidadoTarjetasCredito.class);
      ...
      for (int i = 0; i < registros.size(); i++) {
        ...
        for (int j = 0; j < producto.size(); j++) {
          ...
          if (numeroCuentaApp.equals(numeroCuentaBanco)) {
            ...
            resultadoRegistro =
                validarCampo("TIPO DE TARJETA", tipoCuentaBanco, tipoCuentaApp, resultadoDato);
            resultadoRegistro =
                validarCampo("CUPO DE TARJETA", saldoBanco, saldoApp, resultadoDato);
          }
        }
      }
