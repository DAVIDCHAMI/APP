...
public class AvancesPage
{
    ...
    public static final Target SECURITY_CODE = Target.the("session para avances").located(theElementBy(CODE_SECURITY));
    public static final Target BUTTON_SIGUEINTE = Target.the("session para avances").located(theElementBy(BTN_SIGUIENTE));
