...
public class SaldosMovimientosLocator {
    ...
    public static final Locator VER_MOVIMIENTOS_LOCATOR = locator().withAndroid("xpath$(//div[contains(@id,'ContentAccountElement')])[{0}]").withIos("xpath$(((//XCUIElementTypeStaticText[@name='Movimientos'])[1]/../following-sibling::XCUIElementTypeOther//XCUIElementTypeImage/../following-sibling::XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeStaticText)[{0}]/../../following-sibling::XCUIElementTypeOther/XCUIElementTypeStaticText)[1]");
    ...
    public static final Locator MOVIMIENTOS_EPREPAGO_FECHA_VALOR_LOCATOR = locator().withAndroid("xpath$//div[@class='datalist-padding']").withIos("xpath$(//XCUIElementTypeOther[@name='Saldo disponible']//following::XCUIElementTypeOther[{0}]//XCUIElementTypeStaticText)[{1}]");
    public static final Locator MOVIMIENTOS_EPREPAGO_DES_LOCATOR = locator().withAndroid("xpath$//div[@class='datalist-padding']").withIos("xpath$//XCUIElementTypeOther[@name='Saldo disponible']//following::XCUIElementTypeOther[{0}]//XCUIElementTypeStaticText");
    public static final Locator LBL_FECHA_MOVIMIENTO_CUENTAS_LOCATOR = locator().withAndroid("xpath$(//div[contains(@id,'ContentAccountElement')]//div[@class='datalist-date']/span[1])[{0}]").withIos("xpath$(((//XCUIElementTypeStaticText[@name='Movimientos'])[1]/../following-sibling::XCUIElementTypeOther//XCUIElementTypeImage/../following-sibling::XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeStaticText)[{0}]/../..//XCUIElementTypeStaticText)[1]");
    public static final Locator LBL_DESCRIPCION_MOVIMIENTO_CUENTAS_LOCATOR = locator().withAndroid("xpath$(//div[contains(@id,'ContentAccountElement')]//div//div[2]/span[1])[{0}]").withIos("xpath$(((//XCUIElementTypeStaticText[@name='Movimientos'])[1]/../following-sibling::XCUIElementTypeOther//XCUIElementTypeImage/../following-sibling::XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeStaticText)[{0}]/../../following-sibling::XCUIElementTypeOther/XCUIElementTypeStaticText)[1]");
    public static final Locator LBL_SALDO_CUENTASLOCATOR = locator().withAndroid("xpath$(//div[contains(@id,'ContentAccountElement')]//span[@class='datalist-movements-value ThemeGrid_MarginGutter'])[{0}]").withIos("xpath$((//XCUIElementTypeStaticText[@name='Movimientos'])[1]/../following-sibling::XCUIElementTypeOther//XCUIElementTypeImage/../following-sibling::XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeStaticText)[{0}]");
    ...
    public static final Locator LBL_FECHA_MOVIMIENTO_EPREPAGO_LOCATOR = locator().withAndroid("xpath$(//span[@class='OSFillParent'])[{0}]").withIos("xpath$//XCUIElementTypeOther[./XCUIElementTypeStaticText[@name='Movimientos']]/following-sibling::XCUIElementTypeOther[1]/XCUIElementTypeOther[7][./XCUIElementTypeImage]/following-sibling::XCUIElementTypeOther[{0}]/XCUIElementTypeStaticText");
    ...
    public static final Locator LBL_DESCRIPCION_MOVIMIENTO_EPREPAGO_LOCATOR = locator().withAndroid("xpath$(//span[@class='font-family-OpenSans-regular font-size-s OSFillParent'])[{0}]").withIos("xpath$//XCUIElementTypeOther[./XCUIElementTypeStaticText[@name='Movimientos']]/following-sibling::XCUIElementTypeOther[1]/XCUIElementTypeOther[7][./XCUIElementTypeImage]/following-sibling::XCUIElementTypeOther[{0}]/following-sibling::XCUIElementTypeOther[1]/XCUIElementTypeStaticText");
    ...
    public static final Locator LBL_SALDO_MOVIMIENTO_EPREPAGO_LOCATOR = locator().withAndroid("xpath$(//span[@class='datalist-movements-value' and not(contains(text(),'USD'))])[{0}]").withIos("xpath$//XCUIElementTypeOther[./XCUIElementTypeStaticText[@name='Movimientos']]/following-sibling::XCUIElementTypeOther[1]/XCUIElementTypeOther[7][./XCUIElementTypeImage]/following-sibling::XCUIElementTypeOther[{0}]/XCUIElementTypeOther/XCUIElementTypeStaticText");
    ...
    public static final Locator LBL_DEUDA_PESOS_TC_VISTA_CARRUSEL_LOCATOR = locator().withAndroid("xpath$(//span[not(contains( text(),'USD')) and contains(@class,'amount')])[{0}]").withIos("xpath$test");
    ...
    public static final Locator LBL_VER_DETALLE_ECARD_CARRUSEL_LOCATOR = locator().withAndroid("xpath$//div[contains(@id,'CreditCardDataContainer2')]//span[contains(text(),'VER DETALLE')]").withIos("xpath$test");
