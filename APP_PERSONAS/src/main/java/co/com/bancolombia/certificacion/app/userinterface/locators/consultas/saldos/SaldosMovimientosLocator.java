...
public class SaldosMovimientosLocator {
    ...
    public static final Locator VER_MOVIMIENTOS_EPREPAGO_LOCATOR = locator().withAndroid("xpath$//div[@id='l3-{0}-$b32']").withIos("xpath$//XCUIElementTypeOther[./XCUIElementTypeStaticText[@name='Movimientos']]/following-sibling::XCUIElementTypeOther[1]/XCUIElementTypeOther[7][./XCUIElementTypeImage]/following-sibling::XCUIElementTypeOther[{0}]/XCUIElementTypeStaticText");
    ...
    public static final Locator LBL_FECHA_MOVIMIENTO_EPREPAGO_LOCATOR = locator().withAndroid("xpath$//div[@id='l3-{0}-$b32']/div/div/div/span[2]/preceding-sibling::span").withIos("xpath$//XCUIElementTypeOther[./XCUIElementTypeStaticText[@name='Movimientos']]/following-sibling::XCUIElementTypeOther[1]/XCUIElementTypeOther[7][./XCUIElementTypeImage]/following-sibling::XCUIElementTypeOther[{0}]/XCUIElementTypeStaticText");
    ...
    public static final Locator LBL_DESCRIPCION_MOVIMIENTO_EPREPAGO_LOCATOR = locator().withAndroid("xpath$//div[@id='l3-{0}-$b32']/div/div/div[2]/span").withIos("xpath$//XCUIElementTypeOther[./XCUIElementTypeStaticText[@name='Movimientos']]/following-sibling::XCUIElementTypeOther[1]/XCUIElementTypeOther[7][./XCUIElementTypeImage]/following-sibling::XCUIElementTypeOther[{0}]/following-sibling::XCUIElementTypeOther[1]/XCUIElementTypeStaticText");
    ...
    public static final Locator LBL_SALDO_MOVIMIENTO_EPREPAGO_LOCATOR = locator().withAndroid("xpath$//div[@id='l3-{0}-$b32']/div/div/div/span[2]").withIos("xpath$//XCUIElementTypeOther[./XCUIElementTypeStaticText[@name='Movimientos']]/following-sibling::XCUIElementTypeOther[1]/XCUIElementTypeOther[7][./XCUIElementTypeImage]/following-sibling::XCUIElementTypeOther[{0}]/XCUIElementTypeOther/XCUIElementTypeStaticText");
