...
public class ConsultarDetalleFacturaLocator {
    ...
    public static final Locator LBL_DESCRIPCION_FACTURA_LOCATOR = locator().withAndroid("xpath$(//div[@id='l1-{0}-AccountDataContainer']//span)[1]").withIos("xpath$((//XCUIElementTypeStaticText[@name='Buscar'])[2]/../../preceding-sibling:: XCUIElementTypeOther/XCUIElementTypeOther//XCUIElementTypeStaticText[@name='Valor a pagar'])[{0}]/../preceding-sibling:: XCUIElementTypeOther[3]/XCUIElementTypeOther//XCUIElementTypeStaticText");
    public static final Locator LBL_EMPRESA_CONVENIO_LOCATOR = locator().withAndroid("xpath$(//div[@id='l1-{0}-AccountDataContainer']//span)[2]").withIos("xpath$((//XCUIElementTypeStaticText[@name='Buscar'])[2]/../../preceding-sibling:: XCUIElementTypeOther/XCUIElementTypeOther//XCUIElementTypeStaticText[@name='Valor a pagar'])[{0}]/../preceding-sibling:: XCUIElementTypeOther[2]/XCUIElementTypeStaticText");
    public static final Locator LBL_FECHA_LOCATOR = locator().withAndroid("xpath$(//div[@id='l1-{0}-AccountDataContainer']//span)[3]").withIos("xpath$((//XCUIElementTypeStaticText[@name='Buscar'])[2]/../../preceding-sibling:: XCUIElementTypeOther/XCUIElementTypeOther//XCUIElementTypeStaticText[@name='Valor a pagar')[{0}]/../preceding-sibling:: XCUIElementTypeOther[1]/XCUIElementTypeStaticText");
    public static final Locator LBL_VALOR_FACTURA_LOCATOR = locator().withAndroid("xpath$(//div[@id='l1-{0}-AccountDataContainer']//span)[5]").withIos("xpath$((//XCUIElementTypeStaticText[@name='Buscar'])[2]/../../preceding-sibling:: XCUIElementTypeOther/XCUIElementTypeOther//XCUIElementTypeStaticText[@name='Valor a pagar')[{0}]/../following-sibling:: XCUIElementTypeOther[1]/XCUIElementTypeStaticText");
    public static final Locator LBL_DESCRIPCION_FACTURA_PROGRAMADA_LOCATOR = locator().withAndroid("xpath$(//div[@id='l3-{0}-AccountDataContainer3']//span)[1]").withIos("xpath$((//XCUIElementTypeStaticText[@name='Buscar'])[2]/../following-sibling::XCUIElementTypeOther/XCUIElementTypeOther//XCUIElementTypeStaticText[@name='Valor a pagar'])[{0}]/../preceding-sibling::XCUIElementTypeOther[3]/XCUIElementTypeOther//XCUIElementTypeStaticText");
    public static final Locator LBL_EMPRESA_CONVENIO_FACTURA_PROGRAMADA_LOCATOR = locator().withAndroid("xpath$(//div[@id='l3-{0}-AccountDataContainer3']//span)[2]").withIos("xpath$((//XCUIElementTypeStaticText[@name='Buscar'])[2]/../following-sibling:: XCUIElementTypeOther/XCUIElementTypeOther//XCUIElementTypeStaticText[@name='Valor a pagar'])[{0}]/../preceding-sibling:: XCUIElementTypeOther[2]/XCUIElementTypeStaticText");
    public static final Locator LBL_FECHA_FACTURA_PROGRAMADA_LOCATOR = locator().withAndroid("xpath$(//div[@id='l3-{0}-AccountDataContainer3']//span)[3]").withIos("xpath$((//XCUIElementTypeStaticText[@name='Buscar'])[2]/../following-sibling:: XCUIElementTypeOther/XCUIElementTypeOther//XCUIElementTypeStaticText[@name='Valor a pagar')[{0}]/../preceding-sibling:: XCUIElementTypeOther[1]//XCUIElementTypeStaticText");
    public static final Locator LBL_VALOR_FACTURA_PROGRAMADA_LOCATOR = locator().withAndroid("xpath$(//div[@id='l3-{0}-AccountDataContainer3']//span)[5]").withIos("xpath$((//XCUIElementTypeStaticText[@name='Buscar'])[2]/../following-sibling:: XCUIElementTypeOther/XCUIElementTypeOther//XCUIElementTypeStaticText[@name='Valor a pagar'])[{0}]/../following-sibling:: XCUIElementTypeOther[1]/XCUIElementTypeStaticText");
