...
public class ChequeLocator {
    ...
    public static final Locator LBL_RANGO_CHEQUES_INCORRECTO_LOCATOR= locator().withAndroid("xpath$//span[text()='No es posible realizar la operación. El cheque o rango están incorrectos.']").withIos("xpath$test");
    public static final Locator LBL_CONTRAORDEN_SIN_CUENTA_CORRIENTE_LOCATOR= locator().withAndroid("xpath$//div[text()='No tienes cuenta corriente para realizar la contraorden.']").withIos("xpath$test");
