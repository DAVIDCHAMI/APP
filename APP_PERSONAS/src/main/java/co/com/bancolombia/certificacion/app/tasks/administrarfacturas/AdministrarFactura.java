...
public class AdministrarFactura {
  ...
  public static Performable conOpcionEditar(
      FacturaBuilder programarFacturasBuilder, String opcion) {
    return instrumented(EditarProgramacion.class, programarFacturasBuilder.build(), opcion);
  }

  public static Performable conOpcionELiminar(
      FacturaBuilder programarFacturasBuilder, String opcion) {
    return instrumented(EliminarFactura.class, programarFacturasBuilder.build(), opcion);
  }

  public static Performable conOpcionConsultarDetalleFacturasInscritas(
      FacturaBuilder programarFacturasBuilder) {
    return instrumented(ConsultarDetalleFacturaInscrita.class, programarFacturasBuilder.build());
  }

  public static Performable conOpcionConsultarDetalleFacturasProgramadas(
      FacturaBuilder programarFacturasBuilder) {
  ...
  public static Performable conHistoricoPago(
      String opcion, FacturaBuilder programarFacturasBuilder) {
    return instrumented(HistoricoPago.class, opcion, programarFacturasBuilder.build());
  }

  public static Performable conOpcionEditarFacturaInscrita(
      FacturaBuilder programarFacturasBuilder) {
    return instrumented(
        ModificarDescripcionFacturaInscrita.class, programarFacturasBuilder.build());
  }

  public static Performable conOpcionPagarProgramadas(
      String opcion, FacturaBuilder opcionFacturaBuilder) {
  ...
  public static Performable conOpcionPagarVariasInscritas(
      String opcion, FacturaBuilder opcionFacturaBuilder) {
