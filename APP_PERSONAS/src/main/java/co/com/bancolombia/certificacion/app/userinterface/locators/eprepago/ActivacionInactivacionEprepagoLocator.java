...
public class ActivacionInactivacionEprepagoLocator {
    ...
    public static final Locator BTN_INACTIVAR_EPREPAGO_LOCATOR = locator().withAndroid("id$Button_CancelYesModal_ActivateBiometrics4").withIos("xpath$n");
    ...
    public static final Locator LBL_INACTIVACION_EXITOSA_LOCATOR = locator().withAndroid("xpath$//*[contains(text(),'Inactivacion')]").withIos("xpath$n");
