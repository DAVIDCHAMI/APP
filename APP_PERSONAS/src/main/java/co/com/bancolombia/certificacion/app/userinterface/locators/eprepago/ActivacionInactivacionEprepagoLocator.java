...
public class ActivacionInactivacionEprepagoLocator {
    ...
    public static final Locator BTN_GENERAR_EPREPAGO_LOCATOR = locator().withAndroid("xpath$//button[contains(text(),'GENERAR')]").withIos("xpath$//XCUIElementTypeButton[@name='GENERAR']");
    ...
    public static final Locator LBL_INACTIVACION_EXITOSA_LOCATOR = locator().withAndroid("xpath$//*[contains(text(),'Inactivación exitosa')]").withIos("xpath$//*[contains(@name,'¡Generación exitosa!')]");
