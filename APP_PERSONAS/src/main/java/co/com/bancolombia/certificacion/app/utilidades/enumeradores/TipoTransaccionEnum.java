...
public enum TipoTransaccionEnum {
  ...
  PAGAR_TARJETAS_DE_CREDITO_NO_PROPIAS(
      MIS_PRODUCTOS, "Pagar tarjetas de crédito", "Pagar tarjetas no propias"),
  PAGAR_CREDITOS(MIS_PRODUCTOS, "Pagar tarjetas de crédito", "Pagar créditos"),
  PAGAR_TARJETAS_DE_CREDITO_PROPIAS(
      MIS_PRODUCTOS, "Pagar tarjetas de crédito", "Pagar tarjetas propias"),
  REALIZAR_AVANCES_DESEMBOLSOS(MIS_PRODUCTOS, "Realizar avances y desembolsos", ""),
  PROGRAMAR_PAGAR_FACTURAS(
      MIS_PRODUCTOS, "Pagar y administrar facturas", "Programar y pagar facturas"),
  CONSULTAR_DETALLE_FACTURA(
      MIS_PRODUCTOS, "Pagar y administrar facturas", "Programar y pagar facturas"),
