...
public class SeleccionarCategoria implements Interaction {
  ...
  public <T extends Actor> void performAs(T actor) {
    if (!CUENTAS.equals(categoria)) {
      actor.attemptsTo(
          Check.whether(elementoVisible(actor, OPCION_SELECCIONAR_CATEGORIA_PRODUCTOS.of(CUENTAS)))
              .andIfSo(Click.on(OPCION_SELECCIONAR_CATEGORIA_PRODUCTOS.of(CUENTAS))),
          RealizarScroll.hastaPosicionDeTarget(
              OPCION_SELECCIONAR_CATEGORIA_PRODUCTOS.of(categoria)),
