...
public class RegistroLocator {
    public static final Locator TXT_CREAR_USUARIO_LOCATOR = locator().withAndroid("id$Input_usuario2").withIos("xpath$//XCUIElementTypeTextField[contains(@value,'Crea un usuario')]");
