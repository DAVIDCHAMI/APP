...
public class SolicitarTarjetaVirtualEprepagoPage {
    ...
    public static final Target LBL_SALDO_DISPONIBLE_EPREPAGO = Target.the("Label que muestra el saldos de la tarjeta solicitada").located(theElementBy(LBL_SALDO_DISPONIBLE_EPREPAGO_LOCATOR));
