...
public class BilleteraLocator {
    ...
    public static final Locator LBL_TARJETAS_LISTADAS_LOCATOR = locator().withAndroid("xpath$//").withIos("");
    public static final Locator BTN_ACTIVAR_TARJETA_LOCATOR = locator().withAndroid("xpath$//").withIos("");
    public static final Locator LBL_ACTIVACION_EXITOSA_LOCATOR = locator().withAndroid("xpath$//").withIos("");
