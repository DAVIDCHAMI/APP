...
public class InscripcionClaveDinamicaPage {
    ...
    public static final Target CHK_TIPO_CORREO = Target.the("Selecciona el tipo de correo").locatedBy(dynamicElement(CHK_TIPO_LOCATOR));
    ...
    public static final Target LNL_COMPROBANTE_CLAVE_DINAMICA = Target.the("Datos para verificación registro clave dinámica").located(theElementBy(LBL_COMPROBANTE_CLAVE_DINAMICA_LOCATOR));
