...
public class InscripcionClaveDinamicaPage {
    ...
    public static final Target LNL_COMPROBANTE_CLAVE_DINAMICA = Target.the("Datos para verificacion registro clave dinamica").located(theElementBy(LBL_COMPROBANTE_CLAVE_DINAMICA_LOCATOR));
