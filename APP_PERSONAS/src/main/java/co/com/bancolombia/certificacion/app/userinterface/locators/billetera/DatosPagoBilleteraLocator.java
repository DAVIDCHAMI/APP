...
public class DatosPagoBilleteraLocator {
  public static final Locator TXT_INGRESAR_VALOR_PAGO_LOCATOR =
      locator().withAndroid("xpath$//div[@class='content']").withIos("xpath$d");
  public static final Locator TXT_INGRESAR_VALOR_PROPINA_LOCATOR =
      locator().withAndroid("xpath$//div[@class='content']").withIos("xpath$d");
  public static final Locator BTN_SIGUIENTE_PAGO_LOCATOR =
      locator().withAndroid("xpath$//div[@class='content']").withIos("xpath$d");
