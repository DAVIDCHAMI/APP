...
public class InscribirPage {
    ...
    public static final Target TXT_EMPRESA_SERVICIO_POP_UP = Target.the("Primer posicion pop up empresa o servicio").located(theElementBy(TXT_EMPRESA_SERVICIO_POP_UP_LOCATOR));
