...
public enum ArchivosLogCanalIseries {
  COMFFLGWWW0369(
      FabricaLogCanal.elLogCanal0369(),
      AfirmacionDelProducto.class,
      AfirmacionDelProducto.NO_FUNCIONA),
  COMFFLGWWW0360(
      FabricaLogCanal.elLogCanal0360(),
      AfirmacionDelProducto.class,
      AfirmacionDelProducto.NO_FUNCIONA),
  COMFFLGWWW0345(
      FabricaLogCanal.elLogCanal0345(),
      AfirmacionDelProducto.class,
      AfirmacionDelProducto.NO_FUNCIONA),
  COMFFLGWWW1756(
      FabricaLogCanal.elLogCanal1756(),
      AfirmacionDelProducto.class,
      AfirmacionDelProducto.NO_FUNCIONA),
  COMFFLGWWW0260(
      FabricaLogCanal.elLogCanal0260(),
      AfirmacionDelProducto.class,
      AfirmacionDelProducto.NO_FUNCIONA),
  COMFFLGWWW0410(
      FabricaLogCanal.elLogCanal0410(),
      AfirmacionDelProducto.class,
      AfirmacionDelProducto.NO_FUNCIONA),
  COMFFLGWWW1228(
      FabricaLogCanal.elLogCanal1228(),
      AfirmacionDelProducto.class,
      AfirmacionDelProducto.NO_FUNCIONA),
  COMFFLGWW00228(
      FabricaLogCanal.elLogCanal0228(),
      AfirmacionDelProducto.class,
      AfirmacionDelProducto.NO_FUNCIONA),
  ;
