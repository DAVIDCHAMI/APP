...
public class ProgramarPagarFacturasLocator {
    ...
    public static final Locator LST_FRECUENCIA_PERIODICAD_LOCATOR = locator().withAndroid("xpath$//android.view.View[@text='Selecciona la frecuencia']/..//android.view.View[@text='Quincenal']");
