...
public class ProgramarPagarFacturasLocator {
    ...
    public static final Locator LST_NUMERO_INTENTOS_PROGRAMAR_LOCATOR = locator().withAndroid("xpath$//span[text()='Ingresa los intentos de pago']/..").withIos("xpath$//XCUIElementTypeOther[./XCUIElementTypeStaticText[@name='Ingresa los intentos de pago']]/following-sibling::XCUIElementTypeOther[1]/XCUIElementTypeImage");
    ...
    public static final Locator BTN_PROGRAMAR_LOCATOR = locator().withAndroid("xpath$//button[@id='btn']").withIos("xpath$//XCUIElementTypeButton[@name='PROGRAMAR']");
    ...
    public static final Locator TXT_VALOR_LOCATOR = locator().withAndroid("xpath$//input[@id='Input_Value']").withIos("xpath$//XCUIElementTypeOther[./XCUIElementTypeStaticText[@name='Pagar']]/following-sibling::XCUIElementTypeOther[1]/XCUIElementTypeOther[2]//XCUIElementTypeStaticText");
    ...
    public static final Locator TXT_PAGO_REDEBAN_EXITOSO_LOCATOR = locator().withAndroid("xpath$a").withIos("xpath$a");
    ...
    public static final Locator CHk_SELECCIONAR_FACTURA_LOCATOR = locator().withAndroid("xpath$//span[contains(text(),'{0}')]/../../preceding-sibling::div//span[contains(text(),'{1}')]/../../../preceding-sibling::div//span[contains(text(),'{2}')]/../../../../../..//input")
            .withIos("xpath$//XCUIElementTypeOther[./XCUIElementTypeOther[2]/XCUIElementTypeStaticText[contains(@name,'{0}')]]/preceding-sibling::XCUIElementTypeOther[1][./XCUIElementTypeStaticText[@name='{1}']]/preceding-sibling::XCUIElementTypeOther[4][./XCUIElementTypeStaticText[@name='{2}']]/preceding-sibling::XCUIElementTypeOther[2]/XCUIElementTypeSwitch");
    public static final Locator LBL_PAGO_EXITOSO_FACTURA_LOCATOR = locator().withAndroid("xpath$//span[contains(text(),'¡Pago exitoso!')]").withIos("xpath$//*[contains(@name,'¡Pago exitoso!')]");
