...
public class InscripcionProductoLocator {
    ...
    public static final Locator ITEM_NOMBRE_BANCO_LOCATOR = locator().withAndroid("xpath$//div[contains(@id,'SearchResult')]/div/div[1]/span").withIos("xpath$//XCUIElementTypeStaticText[@name='{0}']");
