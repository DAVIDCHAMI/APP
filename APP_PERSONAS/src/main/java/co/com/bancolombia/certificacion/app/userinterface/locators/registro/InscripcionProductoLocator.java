...
public class InscripcionProductoLocator {
    ...
    public static final Locator ITEM_NOMBRE_BANCO_LOCATOR = locator().withAndroid("xpath$//span[text()='{0}']").withIos("xpath$//XCUIElementTypeStaticText[@name='{0}']");
    ...
    public static final Locator FOCO_LOCATOR = locator().withAndroid("xpath$test").withIos("xpath$//XCUIElementTypeStaticText[contains(@name,'Datos')]");
