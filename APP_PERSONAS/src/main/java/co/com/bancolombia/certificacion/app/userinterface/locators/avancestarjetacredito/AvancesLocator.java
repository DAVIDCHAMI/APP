...
public class AvancesLocator
{
    ...
    public static final Locator IMG_TARJETA_GENERAL_SELECCIONADA_LOCATOR = locator().withAndroid("xpath$").withIos("xpath$//XCUIElementTypeStaticText[@name='Ingresa el código de seguridad']/../preceding-sibling::XCUIElementTypeOther[2]/XCUIElementTypeImage");
    ...
    public static final Locator BTN_REALIZA_AVANCES_LOCATOR = locator().withAndroid("xpath$//span[contains(text(),'Realizar avances')]").withIos("xpath$//XCUIElementTypeStaticText[@name='Realizar avances']");
