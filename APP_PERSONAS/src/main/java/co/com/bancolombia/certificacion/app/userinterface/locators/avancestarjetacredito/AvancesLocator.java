...
public class AvancesLocator {
    ...
    public static final Locator BTN_REALIZAR_AVANCES_LOCATOR = locator().withAndroid("xpath$(//span[contains(text(),'Realizar avances')])[2]").withIos("xpath$d");
    public static final Locator TXT_VALOR_AVANCE_LOCATOR = locator().withAndroid("xpath$//input[@id='Input_Valor']").withIos("xpath$//XCUIElementTypeApplication[@name='Personas']/XCUIElementTypeWindow[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeWebView/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[9]");
    ...
    public static final Locator LST_PRODUCTO_DESTINO_LOCATOR = locator().withAndroid("xpath$//span[text()='{0}']").withIos("xpath$//XCUIElementTypeApplication[@name='Personas']/XCUIElementTypeWindow[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeWebView/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[10]/XCUIElementTypeOther/XCUIElementTypeStaticText");
