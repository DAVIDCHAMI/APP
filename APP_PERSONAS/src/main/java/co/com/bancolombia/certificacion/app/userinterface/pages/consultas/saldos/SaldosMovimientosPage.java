...
public class SaldosMovimientosPage {
    ...
    public static final Target CUENTA_ESPECIFICA_INVERSION = Target.the("Producto especifico en saldos y movimientos para inversion").locatedBy(dynamicElement(OPT_CUENTA_INVERSION_LOCATOR));
