...
public class SaldosMovimientosPage {
    ...
    public static final Target LBL_SALDO_SALDOS_MOVIMIENTOS = Target.the("Saldo cuenta deposito").locatedBy(dynamicElement(LBL_SALDO_SALDOS_MOVIMIENTOS_LOCATOR));
