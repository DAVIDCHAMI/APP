...
import co.com.bancolombia.certificacion.app.userinterface.locators.consultas.saldos.SaldosMovimientosLocator;
...
public class SaldosMovimientosPage {
    ...
    public static final  Target BTN_DEVOLVER_PANTALLA  = Target.the("Boton para devolver a pantalla anterior").located(theElementBy(SaldosMovimientosLocator.BTN_DEVOLVER_PANTALLA));
    ...
    public static final Target CONTENEDOR_MOVIMIENTOS_TARJETA = Target.the("Contenedor con detalles de movimiento de tarjetas de crédito").locatedBy(dynamicElement(VER_MOVIMIENTOS_TARJETA_CREDITO_LOCATOR));
    ...
    public static final Target LBL_DESCRIPCION_CUENTA_MOVIMIENTO = Target.the("Label que muestra la descripción del movimiento").locatedBy(dynamicElement(LBL_DESCRIPCION_MOVIMIENTO_CUENTAS_LOCATOR));
