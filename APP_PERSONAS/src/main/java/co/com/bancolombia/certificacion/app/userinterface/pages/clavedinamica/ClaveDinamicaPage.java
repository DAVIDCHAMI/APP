...
public class ClaveDinamicaPage {
  public static final Target LBL_CLAVE_DINAMICA_GENERADA =
      Target.the("Label de Clave Dinamica generada automaticamente")
          .locatedBy(dynamicElement(LBL_CLAVE_DINAMICA_GENERADA_LOCATOR));
  public static final Target LNK_INSCRIBIR_CLAVE_DINAMICA =
      Target.the("Link oara inscribir clave dinamica")
          .locatedBy(dynamicElement(LNK_INSCRIBIR_CLAVE_DINAMICA_LOCATOR));
