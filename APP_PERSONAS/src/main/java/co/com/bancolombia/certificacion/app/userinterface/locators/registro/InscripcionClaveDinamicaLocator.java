...
public class InscripcionClaveDinamicaLocator {
    ...
    public static final Locator TXT_CORREO_CLAVE_LOCATOR = locator().withAndroid("xpath$//input[@id='Input_Email']").withIos("xpath$//XCUIElementTypeStaticText[@name='Ingresa el correo electrónico']/..//following::XCUIElementTypeOther[1]");
    ...
    public static final Locator TXT_SEGUNDA_CLAVE_LOCATOR= locator().withAndroid("xpath$test").withIos("xpath$//XCUIElementTypeStaticText[@name='Ingresa la segunda clave']/..//following-sibling::XCUIElementTypeOther[1]");
    ...
    public static final Locator BTN_CONTINUAR_SEGUNDA_CLAVE_LOCATOR = locator().withAndroid("xpath$//button[@id='Button_Continuar']").withIos("xpath$//XCUIElementTypeStaticText[@name='Continuar']");
