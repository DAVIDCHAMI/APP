...
public class InscripcionClaveDinamicaLocator {
    ...
    public static final Locator CHECK_TIPO_CORREO_LOCATOR= locator().withAndroid("xpath$//android.view.View[@text='Personal']/../android.widget.Button").withIos("");
    public static final Locator BTN_SIGUIENTE_CLAVE_LOCATOR= locator().withAndroid("xpath$//android.widget.Button[@resource-id= 'Button_Next_EmailDK'] ").withIos("");
