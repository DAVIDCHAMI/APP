...
public class InscripcionClaveDinamicaLocator {
    ...
    public static final Locator CHECK_TIPO_CORREO_LOCATOR= locator().withAndroid("xpath$//android.view.View[@text='{0}']/../android.widget.Button").withIos("xpath$test");
    ...
    public static final Locator CHECK_ACEPTO_TERMINOS_LOCATOR= locator().withAndroid("xpath$//android.widget.CheckBox[@resource-id='Checkbox_AcceptTermsConditions_VerifyPhoneDK']").withIos("xpath$test");
    ...
    public static final Locator COMPROBANTE_CLAVE_DINAMICA_LOCATOR = locator().withAndroid("xpath$//android.view.View[contains(@text,'Comprobante')]").withIos("xpath$test");
