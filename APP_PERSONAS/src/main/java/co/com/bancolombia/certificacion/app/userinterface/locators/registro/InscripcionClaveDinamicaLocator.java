...
public class InscripcionClaveDinamicaLocator {
    ...
    public static final Locator CHK_ACEPTO_TERMINOS_LOCATOR = locator().withAndroid("xpath$//android.widget.CheckBox[@resource-id='Checkbox_AcceptTermsConditions_VerifyPhoneDK']").withIos("");
    ...
    public static final Locator LBL_COMPROBANTE_CLAVE_DINAMICA_LOCATOR = locator().withAndroid("xpath$//android.view.View[contains(@text,'Comprobante')]").withIos("");
