...
public class Movimientos {
  ...
  public static List<Movimiento> verifyMovementsEprepagoConsolidated(
      String strNumtarjeta, String strFecha) {
    BackMovimientosEprepago ePrepago = new BackMovimientosEprepago();
    List<Movimiento> movimientosConsolidado = null;
    try {
      movimientosConsolidado =
          ePrepago.consultarMovimientosConsolidado(
  ...
  public static List<Movimiento> verifyMovementsEprepagoDescription(
      String strNumtarjeta, String strDescripcion) {
    BackMovimientosEprepago ePrepago = new BackMovimientosEprepago();
    List<Movimiento> movimientosDescripcion = null;
    try {
      movimientosDescripcion =
          ePrepago.consultarMovimientosPorDescripcion(
  ...
  public static List<Movimiento> verifyMovementsEprepagoDates(
      String strNumtarjeta, String strFechaDesde, String strFechaHasta) {
  ...
  public static List<Movimiento> verifyMovementsEprepagoDescriptionAndDates(
      String strNumtarjeta, String strFechaDesde, String strFechaHasta, String strDescripcion) {
    String[] listDateDesde = strFechaDesde.split("/");
    String[] listDateHasta = strFechaHasta.split("/");
    String strFechaDesdeBack = listDateDesde[2] + listDateDesde[0] + listDateDesde[1];
    String strFechaHastaBack = listDateHasta[2] + listDateHasta[0] + listDateHasta[1];
    ...
    try {
      movimientosFechasyDescripcion =
          ePrepago.movimientosPorFechasyDescripcion(
              AdministradorConstante.NUMERO_BASE_EPREPAGO + strNumtarjeta,
              strFechaDesdeBack,
              strFechaHastaBack,
              strDescripcion);
