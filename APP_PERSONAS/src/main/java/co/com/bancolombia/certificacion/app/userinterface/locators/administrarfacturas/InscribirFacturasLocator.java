...
public class InscribirFacturasLocator {
    public static final Locator BTN_INCRIBIR_MANUALMENTE_LOCATOR = locator().withAndroid("xpath$//span[contains(text(),'manualmente')]/..");
    public static final Locator TXT_EMPRESA_SERVICIO_LOCATOR = locator().withAndroid("xpath$//input[@id='Input_ServiceOrCompany']");
    public static final Locator TXT_EMPRESA_SERVICIO_POP_UP_LOCATOR = locator().withAndroid("xpath$//span[text()='{0}']");
