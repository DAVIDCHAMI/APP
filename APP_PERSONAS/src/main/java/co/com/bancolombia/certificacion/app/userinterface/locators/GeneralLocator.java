...
public class GeneralLocator {
    ...
    public static final Locator LBL_BLOQUEO_EXITOSO_LOCATOR = locator().withAndroid("xpath$//span[contains(text(),'¡Bloqueo exitoso!')  or contains(text(),'exitoso!') or contains(text(),'¡Bloqueo')]").withIos("xpath$//XCUIElementTypeStaticText[@name='¡Bloqueo exitoso!']");
