...
public class GeneralLocator {
    ...
    public static final Locator LNK_SIGUIENTE_LOCATOR = locator().withAndroid("xpath$//span[text()='Siguiente']").withIos("xpath$//XCUIElementTypeLink[contains(@name,'Siguiente')]");
    ...
    public static final Locator LNK_PAGAR_LOCATOR = locator().withAndroid("xpath$//span[text()='Pagar']").withIos("xpath$q");
    ...
    public static final Locator LBL_MENSAJE_CARGA_LOCATOR = locator().withAndroid("xpath$//*[contains(text(),'Cargando') or contains(text(),'Validando Clave')]").withIos("xpath$q");
