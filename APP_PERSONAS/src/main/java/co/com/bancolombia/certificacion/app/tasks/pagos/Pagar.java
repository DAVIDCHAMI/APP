...
public class Pagar {
  public static Performable tarjetaCreditoNoPropia(
      TarjetaCreditoBuilder tarjetaCredito, ProductoBuilder productoDebitar) {
    return instrumented(NoPropia.class, tarjetaCredito.build(), productoDebitar.build());
  }

  public static Performable tarjetaCreditoPropia(
      TarjetaCreditoBuilder tarjetaCredito, ProductoBuilder productoDebitar) {
