...
public class InscripcionProductoPage {
    ...
    public static final Target TXT_TIPO_DOCUMENTO = Target.the("Campo para ingresar tipo de docuemento").located(theElementBy(TXT_TIPO_DOCUMENTO_LOCATOR));
    ...
    public static final Target LBL_NUMERO_PRODUCTO = Target.the("Label tipo de banco inscrito en la pantalla de confirmación").locatedBy(dynamicElement(LBL_NUMERO_PRODUCTO_LOCATOR));
