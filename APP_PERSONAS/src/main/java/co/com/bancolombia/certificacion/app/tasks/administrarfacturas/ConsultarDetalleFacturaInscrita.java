...
public class ConsultarDetalleFacturaInscrita implements Task {
  ...
  public <T extends Actor> void performAs(T actor) {
    actor.attemptsTo(SeleccionarOpcionFactura.conInformacion(OPT_VER_DETALLE_FACTURA, factura));
    actor.remember(
        MODELO_CONSULTA_DETALLE_FACTURA,
        factura()
            .conEmpresaServicio(
                LBL_DETALLE_EMPRESA_SERVICIO
                    .of(factura.getEmpresaServicio())
                    .resolveFor(actor)
                    .getText())
            .conValor(
                LBL_DETALLE_VALOR_PAGAR.of(factura.getValorFactura()).resolveFor(actor).getText())
            .conFechaFactura(
                LBL_DETALLE_FECHA_VENCIMIENTO_FACTURA
                    .of(factura.getFechaFactura())
                    .resolveFor(actor)
                    .getText())
            ...
            .conCanalInscripcionFactura(
                LBL_DETALLE_CANAL_INSCRIPCION_FACTURA.resolveFor(actor).getText())
            .build());
  }
}
