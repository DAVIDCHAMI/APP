...
public class GeneralPage {
    ...
    public static final Target LBL_GENERACION_EXITOSA = Target.the("Label generacion exitosa").located(theElementBy(LBL_GENERACION_EXITOSA_LOCATOR));
    public static final Target LBL_VERIFICACION = Target.the("Label verificacion").locatedBy(dynamicElement(LBL_VERIFICACION_LOCATOR));
