...
public class PagoExitoso implements Question<Boolean> {
  ...
  public Boolean answeredBy(Actor actor) {
    ...
    return LBL_NOMBRE_ESTABLECIMIENTO_CONFIRMAR
            .of(informacionVerificarPago.get(0))
            .resolveFor(actor)
            .isVisible()
        && LBL_TIPO_TARJETA_CONFIRMAR
            .of(informacionVerificarPago.get(1))
            .resolveFor(actor)
            .isVisible()
        && LBL_NUMERO_TARJETA_CONFIRMAR
            .of(informacionVerificarPago.get(2))
            .resolveFor(actor)
            .isVisible()
        && LBL_SUBTOTAL_PAGO_CONFIRMAR
            .of(informacionVerificarPago.get(3))
            .resolveFor(actor)
            .isVisible()
        ...
        && LBL_TOTAL_PAGADO_CONFIRMAR
            .of(informacionVerificarPago.get(7))
            .resolveFor(actor)
            .isVisible()
