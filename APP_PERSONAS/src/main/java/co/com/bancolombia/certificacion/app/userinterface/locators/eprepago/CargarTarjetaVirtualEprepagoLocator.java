...
public class CargarTarjetaVirtualEprepagoLocator {
    ...
    public static final Locator LNK_RECARGAR_EPREPAGO_LOCATOR = locator().withAndroid("xpath$//span[text()='Recargar']/parent::div").withIos("xpath$q");
    ...
    public static final Locator BTN_RECARGAR_EPREPAGO_LOCATOR = locator().withAndroid("xpath$//span[text()='RECARGAR']/parent::button").withIos("xpath$q");
