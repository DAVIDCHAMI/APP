...
public class chequeLocator {
    ...
    public static final Locator LBL_NUMERO_CHEQUE_LOCATOR = locator().withAndroid("xpath$//").withIos("xpath$//XCUIElementTypeStaticText[@name='Cheques Contraordenados']/../following-sibling:: XCUIElementTypeOther//XCUIElementTypeStaticText[@name='{0}']");
    public static final Locator LBL_CUENTA_ASOCIADA_LOCATOR= locator().withAndroid("xpath$//span[text()='Cuenta']/../following-sibling::div//span[text()='{0}']").withIos("xpath$//XCUIElementTypeStaticText[@name='{0}']/../following-sibling::XCUIElementTypeOther//XCUIElementTypeStaticText[@name='{1}']");
    public static final Locator LBL_FOCO_LOCATOR= locator().withAndroid("xpath$//span[text()='Cuenta']/../following-sibling::div//span[text()='{0}']").withIos("xpath$//XCUIElementTypeStaticText[@name='Cheques a contraordenar']");
}