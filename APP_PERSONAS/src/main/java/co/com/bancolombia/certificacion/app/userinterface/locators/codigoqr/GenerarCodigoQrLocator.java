...
public class GenerarCodigoQrLocator {
    ...
    public static final Locator BTN_CON_VALOR_LOCATOR = locator().withAndroid("xpath$//android.view.View[contains(@text,'Con Valor')]/preceding-sibling::android.widget.Button");
    ...
    public static final Locator IMG_CODIGO_QR_PANTALLA_INICIO_LOCATOR = locator().withAndroid("xpath$//android.view.View[contains(@resource-id,'FloatingIcon')]/android.widget.Image");
