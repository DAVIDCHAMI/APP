...
public class GenerarCodigoQrLocator {
    ...
    public static final Locator IMG_CODIGO_QR_LOCATOR = locator().withAndroid("xpath$//div[contains(@id,'QRCode')]").withIos("xpath$//XCUIElementTypeImage[@name='Scan me!']");
