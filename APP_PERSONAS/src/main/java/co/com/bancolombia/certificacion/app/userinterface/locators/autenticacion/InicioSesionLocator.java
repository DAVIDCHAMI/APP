...
public class InicioSesionLocator {
    ...
    public static final Locator TXT_CLAVE_DIGITOS_LOCATOR = locator().withAndroid("id$Input_TextVar").withIos("xpath$//XCUIElementTypeOther[@name='Ingreso de la clave']/XCUIElementTypeOther[9]/XCUIElementTypeOther[3]");
