...
public class InicioSesionLocator {
    ...
    public static final Locator TXT_CLAVE_DIGITOS_LOCATOR = locator().withAndroid("xpath$//div/span[contains(@class,'inputPass OSFillParent')]").withIos("xpath$//XCUIElementTypeOther[@name='Ingreso de la clave']/XCUIElementTypeOther[9]/XCUIElementTypeOther[3]/XCUIElementTypeOther[1]");
    ...
    public static final Locator LBL_USER_YA_REGISTRADO_LOCATOR = locator().withAndroid("xpath$test").withIos("xpath$//XCUIElementTypeStaticText[@name='Usuario o clave inválida. Inténtalo nuevamente.']");
