...
public class InicioSesionLocator {
    ...
    public static final Locator LBL_CLAVE_INVALIDA_LOCATOR = locator().withAndroid("xpath$//android.view.View[@text='CLAVE NO VALIDA']").withIos("xpath$//XCUIElementTypeStaticText[contains(@name,'Usuario o clave inválida. Inténtalo nuevamente.')]");
