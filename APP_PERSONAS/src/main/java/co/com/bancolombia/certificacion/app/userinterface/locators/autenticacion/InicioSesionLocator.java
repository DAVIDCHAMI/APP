...
public class InicioSesionLocator {
    ...
    public static final Locator LBL_CLAVE_INVALIDA_LOCATOR = locator().withAndroid("xpath$//android.view.View[contains(@text,'clave inválida')]").withIos("xpath$//XCUIElementTypeStaticText[contains(@name,'Usuario o clave inválida. Inténtalo nuevamente.')]");
    public static final Locator BTN_CERRAR_MODAL_CLAVE_NO_VALIDA_LOCATOR = locator().withAndroid("xpath$//android.view.View[contains(@text,'clave inválida')]/following-sibling::android.view.View").withIos("xpath$//XCUIElementTypeStaticText[contains(@name,'Usuario o clave inválida. Inténtalo nuevamente.')]/../following-sibling::XCUIElementTypeOther[1]//XCUIElementTypeOther//XCUIElementTypeStaticText");
