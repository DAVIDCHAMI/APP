...
public class BackendFacadeFinacle {

    private BackendFacadeFinacle(){}

    private static final Logger LOGGER = LogManager.getLogger(BackendFacadeFinacle.class.getName());
    /**
