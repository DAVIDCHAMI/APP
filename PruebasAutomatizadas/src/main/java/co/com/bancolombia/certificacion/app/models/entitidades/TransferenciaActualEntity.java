...
import static co.com.bancolombia.certificacion.app.utilities.constantes.AdministradorConstante.CODIGO_OPETACION_TRANSFERENCIA;
import static co.com.bancolombia.certificacion.app.utilities.constantes.AdministradorConstante.CODIGO_TRANSACCION_ACH;
import static co.com.bancolombia.certificacion.app.utilities.constantes.TipoClaseConstante.CLASE_ENTIDAD;


public class TransferenciaActualEntity {
    private static Transferencia transferencia;

    private TransferenciaActualEntity() {
    ...
    public static void setTransferencia(List<String> data) {
        ...
        if (ConfiguracionTransaccionActualEntity.getConfiguracionTransaccion().getCodigoTransaccion().equals(CODIGO_TRANSACCION_ACH)) {
        ...
        TransferenciaActualEntity.transferencia = transfer;
    }
