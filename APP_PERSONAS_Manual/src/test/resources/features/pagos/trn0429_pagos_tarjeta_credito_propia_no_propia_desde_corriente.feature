...
Característica: Trn-0429 pagos de tarjeta de credito propia y no propia en app Bancolombia desde corriente
  Como usuario de Bancolombia
  Quiero pagar una tarjeta de credito propia y no propia
  Para liberar espacio en el cupo de la tarjeta

  @manual
  Esquema del escenario: pago de tarjeta de credito propia master desde una cuenta corriente
    ...
    @manual
    Esquema del escenario: flujo transaccional del pago de tarjeta de credito propia master desde una cuenta corriente
      ...
      |   Autenticacion - 0369    |Saldos consolidados - 1756| Listar TDC - 0260| Detalle DTC - 1260 | Listar cuentas deposito - 0360| Consulta costo -0888| Pago desde cuenta corriente - 0429|