...
Característica: Trn-0529 pagos de tarjeta de credito propia y no propia en app Bancolombia desde ahorro
  Como usuario de Bancolombia
  Quiero pagar una tarjeta de credito propia y no propia
  Para liberar espacio en el cupo de la tarjeta

  @manual
  Esquema del escenario: pago de tarjeta de credito propia master desde una cuenta de ahorro
    ...
    Esquema del escenario: flujo transaccional del pago de tarjeta de credito propia master desde una cuenta de ahorro o corriente
      ...
      |   Autenticacion - 0369    |Saldos consolidados - 1756| Listar TDC - 0260| Detalle DTC - 1260 | Listar cuentas deposito - 0360| Consulta costo -0888| Pago desde cuenta de ahorrro - 0529|